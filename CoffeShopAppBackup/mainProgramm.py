...
def customer_details(db:list,
    ...
    print(chatMessage(requirementsMessage))
    ...
    if mode == "customer":
        ...
        first_response = f"{first_name} We offer drinks & a selection of food in our Cafe."
        print(chatMessage(first_response))
        second_response = "We also sell books and can deliver them to your home." 
        print (chatMessage(second_response))
